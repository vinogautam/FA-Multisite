...
/**
Plugin Name: White Label Branding for WordPress Multisite
Plugin URI: http://plugins.righthere.com/white-label-branding-multisite/
...
require_once WLB_PATH.'multisite/class.plugin_white_label_branding_multisite.php';
...
global $wlb_plugin;
$wlb_plugin = new plugin_white_label_branding_multisite($settings);
